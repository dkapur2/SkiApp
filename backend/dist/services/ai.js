...
const SYSTEM_PROMPT = 'You are a ski resort advisor. Given current conditions at a resort, ' +
 ...
 */
function buildUserMessage(req, skiData) {
    const parts = [`Resort: ${req.resort_name}`];
    // ── Open-Meteo signals ────────────────────────────────────────────────────
 ...
 */
async function getRecommendation(req, skiData) {
